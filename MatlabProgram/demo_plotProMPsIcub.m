...
s_bar=100;
nbInput = [3 6];%9 %number of input used during the inference (here cartesian position)
...
[train{1},test{1}] = partitionTrajectory(t{1},1,percentData,s_bar,1);
...
%plot distribution
drawDistribution(promp{1}, inputName,s_bar,[1:3; 4:6;7:9], 'col', 'b');
drawDistribution(promp{2}, inputName,s_bar,[1:3; 4:6;7:9], 'col', 'r');
...
drawInference(recoPromp,inputName, infTraj, test{1},s_bar, 'Interval', [1:3; 4:6;7:9]);